...
class Dev_css(QsciLexerCSS):
	def __init__(self, *args):
		...
		self.setColor(QColor(255,128,0), QsciLexerCSS.Important)
		...
		self.setColor(QColor(139,120,206), QsciLexerCSS.Value)
		self.setColor(QColor(85,85,255), QsciLexerCSS.ClassSelector)
		self.setColor(QColor(84,84,84), QsciLexerCSS.Comment)
		...
		self.setColor(QColor(170,85,255), QsciLexerCSS.Attribute)
